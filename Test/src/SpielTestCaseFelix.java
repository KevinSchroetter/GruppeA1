...
public class SpielTestCaseFelix {
	public static void main(String[]args){
		...
		a.wähleFigur("S1");
		System.out.println("............................");
		for(int i = 0; i<a.spielbrett.getAlleStartFelderEinerFarbe(FarbEnum.ROT).length;i++){
		System.out.println(a.spielbrett.getAlleStartFelderEinerFarbe(FarbEnum.ROT)[i].getFigur());}
		System.out.println("............................");
		System.out.println("............................");
		for(int j = 0; j<a.getIstAmZug().alleFiguren().length;j++){
			System.out.println(a.getIstAmZug().alleFiguren()[j].binIchGespawnt());
		}
		System.out.println("............................");
		a.würfeln(6);
		a.wähleFigur("1");
